...
// method that we made earlier and return. Write out the provided HTTP status
// code ('200 OK', '400 Bad Request' etc). Execute the template set and write
// the response body. Again, if there is any error we call the the serverError()
// helper.
//
